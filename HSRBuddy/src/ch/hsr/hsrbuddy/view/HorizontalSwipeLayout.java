...
public class HorizontalSwipeLayout extends HorizontalScrollView {
    ...
    public HorizontalSwipeLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }
 
    public HorizontalSwipeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void setFeatureItems(ArrayList<View> items){
        ...
        for (int i = 0; i < items.size(); i++) {
            internalWrapper.addView(items.get(i) , i);
		}
